    ...
    <main id="main" className="app-main">
      <div className="dashboard-head">
        <div>
          ...
          <h1>Maintenance</h1>
          <p>Create, update, complete, and archive recurring home care.</p>
        </div>
        <select
      ...
      <div className="dash-grid" style={{ marginTop: 32 }}>
              ...
              if (editingTaskId === task.id) {
                return (
                  ...
                  >
                    ...
                    <div className="field">
                      <label htmlFor={`task-asset-${task.id}`}>Asset</label>
                      <select
                        id={`task-asset-${task.id}`}
                        name="assetId"
                        defaultValue={task.assetId ?? ""}
                      >
                    ...
                    <div className="field">
                      <label htmlFor={`task-due-${task.id}`}>Next due</label>
                      <input
                        id={`task-due-${task.id}`}
                        name="nextDueAt"
                        type="date"
                        defaultValue={task.nextDueAt.slice(0, 10)}
                        required
                      />
                    </div>
                    <div className="field">
                      <label htmlFor={`task-frequency-${task.id}`}>
                        Frequency
                      </label>
                      <select
                        id={`task-frequency-${task.id}`}
                        name="frequencyType"
                        defaultValue={task.frequencyType}
                      >
                    ...
                    <div className="field">
                      <label htmlFor={`task-interval-${task.id}`}>Every</label>
                      <input
                        ...
                        min="1"
                        max="3650"
                        defaultValue={task.frequencyInterval}
                        required
                      />
                    </div>
                    <div className="field">
                    ...
                    <div className="field">
                      <label htmlFor={`task-duration-${task.id}`}>
                        Estimated minutes
                      </label>
                      <input
        ...
        >
          ...
          <div className="field">
            ...
            <select id="task-asset" name="assetId" disabled={submitting}>
              <option value="">Whole home</option>
              {assets.map((asset) => (
                <option key={asset.id} value={asset.id}>
                  {asset.name}
