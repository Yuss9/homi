      ...
      <div className="dash-grid" style={{ marginTop: 32 }}>
        ...
        <form className="dash-card auth-form" onSubmit={save}>
          ...
          <label className="check-row">
            <input
              ...
              type="checkbox"
              defaultChecked={preferences.weeklySummaryEnabled !== false}
            />{" "}
            Weekly summary
          </label>
          <div className="field">
            ...
            <input
              ...
              min="0"
              max="90"
              defaultValue={String(preferences.maintenanceReminderDays ?? 7)}
            />
          </div>
          <div className="field">
            <label htmlFor="warranty-days">Warranty notice (days)</label>
            <input
              id="warranty-days"
              ...
              min="0"
              max="365"
              defaultValue={String(preferences.warrantyReminderDays ?? 30)}
            />
          </div>
          <div className="field">
            <label htmlFor="document-days">Document notice (days)</label>
            <input
              id="document-days"
        ...
        <section className="dash-card">
          ...
          <p className="muted-copy">
            Homi ships without advertising trackers or third-party analytics.
            Export your account data at any time.
          </p>
          <a className="button button-secondary" href="/api/export/account">
            <Download size={16} />
            Export JSON
          </a>
